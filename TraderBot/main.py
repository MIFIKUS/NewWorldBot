...
def write_in_sheets():
    for i in range(1, 21):
        image.image_to_string(f"TraderBot\\images\\screenshots\\price{i}.png", True), f"Цена {i}"
        image.image_to_string(f"TraderBot\\images\\screenshots\\avail{i}.png", True), f"Количество {i}"
